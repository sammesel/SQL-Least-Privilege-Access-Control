...
DROP PROCEDURE IF EXISTS [tools].[up_sp_configure]
GO
DROP PROCEDURE IF EXISTS [tools].[up_sp_configure_option_value]
GO
DROP PROCEDURE IF EXISTS [tools].[up_sp_configure_show_advanced_options]
GO
DROP PROCEDURE IF EXISTS [tools].[up_sp_configure_advanced_option_value]
GO
/****** Object:  Schema [tools]    Script Date: 12/21/2023 12:00:21 PM ******/
DROP SCHEMA [tools]
GO
