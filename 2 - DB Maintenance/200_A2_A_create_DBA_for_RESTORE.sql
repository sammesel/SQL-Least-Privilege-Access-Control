...
-- for next step: make sure to open a new connection using the login: [DBA_for_RESTORE]
-- DO demos on file: [200_A2_B_login_with_DBA_for_RESTORE_and_restore_databases.sql] 
